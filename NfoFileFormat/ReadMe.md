...
Every public and protected member of all 6 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/MassMediaEdit/blob/main/NfoFileFormat/REFERENCE.md).
